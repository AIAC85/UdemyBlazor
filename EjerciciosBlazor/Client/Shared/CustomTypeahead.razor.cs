...
namespace EjerciciosBlazor.Client.Shared
{
    public class CustomTypeaheadBase<TItem> : ComponentBase, IDisposable
    {
        ...
        [Parameter] public int MinimunLength { get; set; }
        [Parameter] public int Debounce { get; set; }
        [Parameter] public int MaximumSuggestions { get; set; }
        [Parameter] public bool DisplayClear { get; set; }
